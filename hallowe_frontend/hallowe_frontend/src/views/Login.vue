      ...
      <div class="bg-slate-800/50 backdrop-blur-md border-2 border-orange-500 rounded-lg p-8 shadow-2xl">
        ...
        <div class="space-y-4 mb-6">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <button
                ...
                type="button"
                class="absolute right-3 top-1/2 -translate-y-1/2 text-orange-400 hover:text-orange-300"
              >
          ...
          <button
            ...
            class="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-4 rounded-lg transition-all shadow-lg hover:shadow-orange-500/50 hover:shadow-xl mt-6"
          >
        ...
        <div class="relative mb-6">
          <div class="absolute inset-0 flex items-center">
            <div class="w-full border-t border-orange-500/30"></div>
          </div>
          <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-slate-800/50 text-orange-400">eller använd:</span>
          </div>
        </div>
...
const handleEmailAuth = () => {
  console.log(isLogin.value ? 'Login' : 'Register', form.value)
